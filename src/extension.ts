...
export function activate(context: vscode.ExtensionContext) {
  ...
  for (const command of [
    vscode.commands.registerCommand("git-wiki-editor.openWiki", () => openWiki(env)),
    vscode.commands.registerCommand("git-wiki-editor.publishWiki", () => publishWiki(env)),
    vscode.commands.registerCommand("git-wiki-editor.cleanCache", () => cleanCache(env)),
  ]) {
